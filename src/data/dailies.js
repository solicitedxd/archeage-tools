...
export default [
  ...
  },
  {
    ...
    rewards: [{ type: REWARD.COIN, count: 3404 },
      { type: REWARD.ITEM, item: ITEM.UNIDENTIFIED_HIRAM_INFUSION, count: 4 },
      { type: REWARD.ITEM, item: ITEM.AWAKENING_SCROLL, count: 5 }],
    type: TYPE.HIRAM,
  },
  {
  ...
  },
  {
    ...
    zones: [ZONE.REEDWIND],
    rewards: [{ type: REWARD.COIN, count: 3404 },
      { type: REWARD.ITEM, item: ITEM.UNIDENTIFIED_HIRAM_INFUSION, count: 6 },
      { type: REWARD.ITEM, item: ITEM.AWAKENING_SCROLL, count: 10 }],
    type: TYPE.HIRAM,
  },
  {
    name: 'Animal Control',
    zones: [ZONE.WESTERN_HIRAM_MOUNTAINS],
    rewards: [{ type: REWARD.COIN, count: 3728 }, { type: REWARD.ITEM, item: ITEM.MYSTERIOUS_HIRAM_INFUSION, count: 6 },
      { type: REWARD.ITEM, item: ITEM.RADIANT_AWAKENING_SCROLL, count: 7 }],
    type: TYPE.HIRAM,
  },
  {
  ...
  },
  {
    ...
    zones: [ZONE.EASTERN_HIRAM_MOUNTAINS],
    rewards: [{ type: REWARD.ITEM, item: ITEM.RADIANT_HIRAM_INFUSION, count: 10 },
      { type: REWARD.ITEM, item: ITEM.BRILLIANT_AWAKENING_SCROLL, count: 2 }, { type: REWARD.COIN, count: 3728 }],
    type: TYPE.HIRAM,
  },
  {
    name: 'Stop the Abyssal Legion',
    zones: [ZONE.EASTERN_HIRAM_MOUNTAINS],
    rewards: [{ type: REWARD.ITEM, item: ITEM.RADIANT_HIRAM_INFUSION, count: 20 },
      { type: REWARD.ITEM, item: ITEM.BRILLIANT_AWAKENING_SCROLL, count: 4 }, { type: REWARD.COIN, count: 3728 }],
    difficulty: DIFFICULTY.ELITE,
    type: TYPE.HIRAM,
  },
  {
    ...
    rewards: [{ type: REWARD.ITEM, item: ITEM.MYSTERIOUS_HIRAM_INFUSION, count: 20 },
      { type: REWARD.ITEM, item: ITEM.HONORABLE_VICTORY_4, count: 1 }],
    difficulty: DIFFICULTY.EPIC,
    type: TYPE.HIRAM,
  },
  {
