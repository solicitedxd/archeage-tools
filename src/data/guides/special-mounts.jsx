...
// Striped Yata
// Palomino Yata
import BlackYata from 'images/mount/Black_Yata.png';
import Fuchsiafin from 'images/mount/Fuchsiafin.png';
import PolarisBjorne from 'images/mount/Polaris_Bjorne.png';
import Yata from 'images/mount/Yata.png';
...
const sections = [
  {
    ...
    paragraphs: [
      <blockquote>
        In a long race, the average yata could easily outpace the average horse. However, yatas aren't as robust in a
        fight; it's sadly impossible to cuddle something to death.
      </blockquote>,
      <Typography>
      ...
      <Typography>
        ...
        <Currency type={CURRENCY.COIN} count={50000} component="span" />. As such, it isn't as good as the rest.
      </Typography>,
      <Typography>
  ...
  },
  {
    ...
    paragraphs: [
      ...
      <Typography>This mount can be upgraded into <Link to="/guides/upgraded-mounts#ebonfur-bjorne">Ebonfur
        Bjorne</Link>.</Typography>,
      <Typography>
        <Typography color="primary" component="span">Base Move Speed: </Typography>
        10.5 m/s
      </Typography>,
  ...
  },
  {
    ...
    paragraphs: [
      <blockquote>
        It's said Dahuta, the Goddess of the Sea, created this species in a rare moment of tenderness, simply to enjoy
        their beauty. Others claim she utilizes their speed by harnessing them to her personal chariot.
      </blockquote>,
      <Lightbox
        title="Fuschiafin"
        image={Fuchsiafin}
