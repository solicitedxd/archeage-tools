...
add('Fury Canon', SKILLSET.SONGCRAFT, SKILLSET.MALEDICTION, SKILLSET.WITCHCRAFT);
add('Swiftshot', SKILLSET.ARCHERY, SKILLSET.BATTLERAGE, SKILLSET.SWIFTBLADE);
add('Flashblade', SKILLSET.AURAMANCY, SKILLSET.BATTLERAGE, SKILLSET.SWIFTBLADE);
add('Wispwalker', SKILLSET.AURAMANCY, SKILLSET.WITCHCRAFT, SKILLSET.SWIFTBLADE);
add('Mercenary', SKILLSET.BATTLERAGE, SKILLSET.DEFENSE, SKILLSET.SWIFTBLADE);
add('Pitfiend', SKILLSET.BATTLERAGE, SKILLSET.MALEDICTION, SKILLSET.SWIFTBLADE);
add('Cursebrand', SKILLSET.BATTLERAGE, SKILLSET.OCCULTISM, SKILLSET.SWIFTBLADE);
add('Deathwish', SKILLSET.BATTLERAGE, SKILLSET.SHADOWPLAY, SKILLSET.SWIFTBLADE);
add('Bladechanter', SKILLSET.BATTLERAGE, SKILLSET.SONGCRAFT, SKILLSET.SWIFTBLADE);
add('Runebreaker', SKILLSET.BATTLERAGE, SKILLSET.SORCERY, SKILLSET.SWIFTBLADE);
add('Lifestealer', SKILLSET.BATTLERAGE, SKILLSET.VITALISM, SKILLSET.SWIFTBLADE);
add('Phantom', SKILLSET.BATTLERAGE, SKILLSET.WITCHCRAFT, SKILLSET.SWIFTBLADE);
add('Banshee', SKILLSET.DEFENSE, SKILLSET.WITCHCRAFT, SKILLSET.SWIFTBLADE);
