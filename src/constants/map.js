...
export const ZONE = Object.freeze({
  ...
  CASTAWAY_STRAIT: 'Castaway Straight',
  BOILING_SEA: 'Boiling Sea',
  SHATTERED_SEA: 'Shattered Sea',

  FARMERS_WORKSTATION: 'Farmer\'s Workstation',
  MINERS_FARMHOUSE: 'Miner\'s Farmhouse',
  RANCHERS_FARMHOUSE: 'Rancher\'s Farmhouse',
  HARVESTERS_FARMHOUSE: 'Harvester\'s Farmhouse',
  REMODELED_APOTHECARY: 'Remodeled Apothecary House',
  REMODELED_ARMORERS: 'Remodeled Armorer\'s House',
  REMODELED_TRADESMAN: 'Remodeled Tradesman\'s House',
  REMODELED_HOUSE: 'Remodeled House',
  BEANSTALK_HOUSE: 'Beanstalk House',
  MUSHROOM_HOUSE: 'Raised Mushroom House',
...
export const CONTINENT = Object.freeze({
  ...
  CRAFTED: {
    ...
    zones: [
      ...
      ZONE.MINERS_FARMHOUSE,
      ZONE.RANCHERS_FARMHOUSE,
      ZONE.HARVESTERS_FARMHOUSE,
      ZONE.REMODELED_APOTHECARY,
      ZONE.REMODELED_ARMORERS,
      ZONE.REMODELED_TRADESMAN,
      ZONE.REMODELED_HOUSE,
      ZONE.BEANSTALK_HOUSE,
      ZONE.MUSHROOM_HOUSE,
