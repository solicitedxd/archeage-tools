      ...
      <div className="news-list">
        ...
        >
          ...
          <p>I've also created a Discord bot that will post messages every time there's an event about to start in
            ArcheAge.</p>
          <p>Patrons have the perk of being mentioned whenever chosen event types are posted, giving them a direct ping
            as
            a notice.</p>
        ...
        >
          ...
          <p>
            Lastly, I've added "phases" to events. For now, it's only used on Castle Siege and Crimson Rift. Castle
            Siege
          ...
          <Typography variant="caption" component="p">
            ...
            ArchePass Reset and Ayanad Trader have been temporarily disabled until their respective systems are
            re-enabled
        ...
        >
          ...
          <p>
            ...
            with a dropdown to select the pack's freshness profit, a toggle to include interest, and (for Cinderstone
            and
          ...
          <p>
            Library bosses and Siege timers have been added to the Event Schedule for NA. Know when the EU time
            is?&nbsp;
